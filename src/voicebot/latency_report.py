...
def markdown(report):
    ...
    for index, g in enumerate(report['groups'], 1):
        ...
        # Double quotes inside a single-quoted f-string: same-quote nesting is
        # PEP 701, which is 3.12 and up, and this project supports 3.11.
        lines.append(f'- Group {index} — models: {models}; '
                     f'detector: {g["speech_detector"]}; '
                     f'pause policy: {g["endpoint_policy"]}; '
