...
POLICIES: dict[str, Policy] = {
    "TH-4471-0093": Policy(
        ...
        name="Andrew Tan", salutation="Mr", surname="Tan",
    ...
    "TH-5120-7742": Policy(
        ...
        name="Rachel Ng", salutation="Ms", surname="Ng",
    ...
    "TH-8802-1156": Policy(
        ...
        name="Grace Lim", salutation="Ms", surname="Lim",
